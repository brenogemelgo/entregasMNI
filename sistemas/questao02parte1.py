...
def jacobi(A, b, maxit):
    ...
    if Epest <= Eppara:
        return x_new, Epest, maxit, "convergiu"
...
print("Aplicação direta dos métodos iterativos")
...
for sistema in sistemas:
    ...
    x_jacobi, Epest_jacobi, k_jacobi, status_jacobi = jacobi(A, b, maxit)
    x_gs, Epest_gs, k_gs, status_gs = gaussSeidel(A, b, maxit)
